...
excerpt: >
    Эта статья – перевод статьи Rust and the Blub Paradox за авторством Jonathan
    Turner.<br/>

    Несколько недель назад я наткнулся на сравнительный анализ Rust, D
    и Go от Андрея Александреску. Андрей, уважаемый член сообщества
    C++ и главный разработчик языка программирования D, нанес Rust
    сокрушительный удар под конец своего повествования, высказав
    нечто, что выглядит довольно проницательным наблюдением.
---
