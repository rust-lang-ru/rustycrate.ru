...
Вот некоторые цифры:
  ...
  * 20 участников сделали 932 коммита в репозиторий книги и отправили 243 Pull
    Request'а
  * это примерно
    [100 000 строк](https://github.com/rust-lang-ru/rust_book_ru/graphs/contributors)
    изменений
...
[синхронизация](https://github.com/rust-lang-ru/rust_book_ru/issues/3) текущей версии
...
Также нужна система
[отслеживания](https://github.com/rust-lang-ru/rust_book_ru/issues/6) изменений
...
[mdBook](https://github.com/rust-lang/mdBook) — новая программа вёрстки книги из
...
([1](https://github.com/rust-lang-ru/rust_book_ru/issues/8),
[2](https://github.com/rust-lang-ru/rust_book_ru/issues/9)). В то же время, эта
возможность довольно хорошо реализована
в [trpl-ebook](https://github.com/killercup/trpl-ebook). Я пробовал прогонять через trpl-ebook наш перевод
...
[планируют](https://github.com/rust-lang/mdBook/issues/5) интегрировать переводы.
...
кстати, есть незаконченный [перевод](https://github.com/rust-lang-ru/rust-by-example-ru)
...
[типографику](https://github.com/rust-lang-ru/rustycrate.ru/issues/7),
[категории](https://github.com/rust-lang-ru/rustycrate.ru/issues/27),
[теги](https://github.com/rust-lang-ru/rustycrate.ru/issues/26),
и [поиск](https://github.com/rust-lang-ru/rustycrate.ru/issues/28). Сайт работает
...
[ведения проекта](https://github.com/rust-lang-ru/rustycrate.ru/issues/45), настройке
[Continuous Integration](https://github.com/rust-lang-ru/rustycrate.ru/issues/40),
[кросс-компиляции](https://github.com/rust-lang-ru/rustycrate.ru/issues/38), менеджеру
проектов [Cargo](https://github.com/rust-lang-ru/rustycrate.ru/issues/37). Нам нужен
раздел [ссылок](https://github.com/rust-lang-ru/rustycrate.ru/issues/68)
и [каталог проектов](https://github.com/rust-lang-ru/rustycrate.ru/issues/69) —
