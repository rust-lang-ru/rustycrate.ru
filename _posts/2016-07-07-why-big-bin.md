...
Завершающим штрихом в нашем шаманстве могло быть удаление из исполняемого файла всей стандартной библиотеки. В большинстве случаев это не нужно, да и к тому же в [официальной книге](https://doc.rust-lang.org/1.16.0/book/no-stdlib.html) (или в [переводе](http://rurust.github.io/rust_book_ru/src/no-stdlib.html)) все шаги подробно описаны. Этим способом можно получить файл размером, сопоставимым с аналогом на Си.
