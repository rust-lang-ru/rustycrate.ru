...
## Реализация сквозного функционала при помощи пре- и пост-процессинга <!-- yaspeller ignore -->
...
специального типажа `Chain`, позволяющего формировать цепь вызовов пре- <!-- yaspeller ignore -->
и пост-обработчиков.
