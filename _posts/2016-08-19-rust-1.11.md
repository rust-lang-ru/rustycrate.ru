...
[MIR скоро станет транслятором по-умолчанию][MIR becoming the default] и
постепенно становится доступна [инкрементальная компиляция][incremental compilation].
