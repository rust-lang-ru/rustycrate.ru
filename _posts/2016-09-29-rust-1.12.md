...
{% asset '2016-09-29-rust-1.12/borrowck-error.png' alt='Новая ошибка заимствования' %}
...
{% asset '2016-09-29-rust-1.12/old-mismatched-trait-error.png' alt='Старая ошибка заимствования' %}
...
{% asset '2016-09-29-rust-1.12/mismatched-trait-error.png' alt='Старая ошибка заимствования' %}
