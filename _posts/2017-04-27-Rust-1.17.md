...
Обратная трассировка [теперь имеет более приятное форматирование](https://github.com/rust-lang/rust/pull/38165), опуская некоторые незначительные делали по умолчанию. Например, полная обратная трассировка:
