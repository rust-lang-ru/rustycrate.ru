...
Язык программирования Rust сосредоточен на безопасности, скорости и параллелизме. Давайте проверим, насколько Rust быстрый по сравнению с языками C и Vala. Для этого реализуем алгоритм решения интересной головоломки Lights Off на трёх компилируемых языках программирования 

* C
* Vala
* Rust

и сравним их скорость.
