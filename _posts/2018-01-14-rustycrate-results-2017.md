...
он не заработал. Комменатариев практически нет.
...
Кампания оказалась достаточно успешной. На пике мы собирали примено 100$ в месяц
(после комиссий).
...
Вот [heatmap калала easy](https://gitter.im/ruRust/easy/archives/all):
...
Активность на форуме возрасла, особенно в конце года. Стало появляться больше
