...
в функциональные языки и применяется в написании многопоточных програм.
...
- есть много других вариантов реализации персистентных коллекий, которые ставят
...
вы хотите сохранить исходный вектор, мы должны cклонировать его, что делает
