---
categories: обучение
title: "Пишем простой вэб сервис на языке программирования Rust"
author: Daniel Welch
...
быстро развивающийся и еще не использует версионные релизы. Hass.io имеет дополнения,
...
Это будет JSON-сериализованное сообщение, которое будет отправлено в ответ на успешный запрос.
